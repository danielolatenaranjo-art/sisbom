...
struct SisBomBackground<Content: View>: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            // Watermark Shield Logo at Bottom-Right
            Image("logo")
                ...
                .position(x: UIScreen.main.bounds.width - 80, y: UIScreen.main.bounds.height - 80)
                .ignoresSafeArea()
    ...
    var body: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 14)
                .fill(isDark ? Color.darkCardSurface : Color.lightCardSurface)
                .background(.ultraThinMaterial) // Native iOS Blur effect
        )
        .overlay(
            RoundedRectangle(cornerRadius: 14)
                .stroke(isDark ? Color.darkCardBorder : Color.lightCardBorder, lineWidth: 1.5)
        )
    }
}
