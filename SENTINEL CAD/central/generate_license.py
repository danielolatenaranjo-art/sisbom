...
SECRET_SALT = "SentinelCADSecuritySecretSaltKey"
...
def main():
    print("========================================")
    print("Generador de Licencias - Central de Alarmas")
    print("========================================")
    ...
    try:
        ...
        print("Coloque este archivo en la misma carpeta del ejecutable de Central de Alarmas.")
